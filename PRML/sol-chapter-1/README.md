...
The minimization of the sum-of-squares error function of the polynomial has a unqiue solution that can be found in closed form.  You can read section 1.1 in the  PRML book for more explaination.         
